...
// Miejsce na Twój kod.
    ...
    */
   // Miejsce na Twój kod.
   function inzynieriaOdtylcowa(string){
   ...
   // Miejsce na Twój kod.
   function xNzq(pages){
       pages.sort((a, b) => a.strona - b.strona);
       const pagesToRead = pages.filter((obj, index) => {
           return index === pages.findIndex(o => obj.strona === o.strona);
        });
        return pagesToRead;
    }
    /* 8 */
    ...
    */
   // Miejsce na Twój kod.
   function detektor(string1, string2){
...
*/
// Miejsce na Twój kod.
    function mors(morseCode){
        morseAlphabet = {
                ".-": "a", "-...": "b", "-.-.": "c", "-..": "d", ".": "e", "..-.": "f", "--.": "g", "....": "h", "..": "i", ".---": "j",
                "-.-": "k", ".-..": "l", "--": "m", "-.": "n", "---": "o", ".--.": "p", "--.-": "q", ".-.": "r", "...": "s", "-": "t",
                "..-": "u", "...-": "v", ".--": "w", "-..-": "x", "-.--": "y", "--..": "z"
        }
        return morseCode.split('/').map(word => word.split(' ').map(character => morseAlphabet[character]).join('')).join(' ');
        }
